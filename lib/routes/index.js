...
(function() {
  ...
  exports.index = function(req, res) {
    var credentials, getMetaData, searchParam;
    searchParam = {
      allergy: 'allergy',
      diet: 'diet',
      cuisine: 'cuisine',
    ...
    getMetaData = function(param, credentials, callback) {
      var yummlyUrl;
    ...
    getMetaData(searchParam.allergy, credentials, function(err, data) {
      var allergyData, courseData, cuisineData, dietData;
      console.log(data);
      dietData = [
        {
          "id": "386",
